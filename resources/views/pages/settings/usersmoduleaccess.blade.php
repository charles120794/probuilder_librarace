...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"> <i class="fa fa-dashboard fa-fw"></i> Users Module Access </li>
	</ol>
</section>
...
<div class="content">
	<div class="box box-primary">
		<div class="box-body" id="users_box" style="min-height: 75vh;">
			<div class="panel panel-default">
				<div class="panel-heading clearfix" style="background-color: white;">
					<h3 class="panel-title pull-left">
						<label><i class="fa fa-desktop"></i> USERS MODULE ACCESS </label>
					</h3>
			...
			<div class="panel panel-default">
				<form method="post" id="form_update_users_module"> {{ csrf_field() }}
...
<script type="text/javascript">
	...
	function submitFormSearch(countRequired = 0) {
		...
		if(countRequired == 0) {
			...
			$.ajax({
			    url : '{{ route('settings.route', ['path' => $path, 'action' => 'settings-search-users-module', 'id' => Crypt::encrypt('')]) }}',
			    method : "post",
    ...
    function updateUserModule(event, option = '') {
    	$('.box-overlay-loader').show();
        $.ajax({
            url : '{{ route('settings.route',['path' => $path, 'action' => 'settings-update-users-module-access', 'id' => Crypt::encrypt('')]) }}',
            method : "post",
