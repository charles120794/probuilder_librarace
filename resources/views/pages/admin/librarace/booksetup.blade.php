				...
				<div class="panel-body">
					<div class="nav-tabs-custom"> 
					    <ul class="nav nav-tabs">
					        <li class="active"><a href="#allbooks" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL BOOKS </b></a></li>
					        <li><a href="#newbooks" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD BOOK </b></a></li>
					    </ul>
					</div>
					<div class="tab-content">
						<div class="tab-pane active fade in" id="allbooks"> 
							<div class="panel panel-default">
