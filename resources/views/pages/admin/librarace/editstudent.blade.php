                ...
                <div class="panel-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li><a href="#allstudent" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL STUDENT </b></a></li>
                            <li><a href="#addstudent" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD STUDENT </b></a></li>
                            <li class="active"><a href="#editstudent" data-toggle="tab"><b> <i class="fa fa-edit"></i> EDIT STUDENT </b></a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade" id="allstudent">
                            <div class="panel panel-default">
                                <div class="panel-body">
                        ...
                        <div class="tab-pane fade active in" id="editstudent">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    @include('pages.admin.librarace.forms.formeditstudent')
                                </div>
                            </div>
                        </div>
                    </div>
